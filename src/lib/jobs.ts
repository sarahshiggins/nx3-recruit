...
export const jobs: JobListing[] = [
  {
    id: "1",
    slug: "genai-prototype-engineer",
    title: "GenAI Prototype Engineer",
    location: "Chicago, IL",
    type: "Full-time",
    department: "Engineering",
    summary:
      "Join NX3 Labs as a core member of a small, focused engineering team working at the leading edge of AI.",
    description: `## About the Role

You will join NX3 Labs as a core member of a small, focused engineering team working at the leading edge of AI. Track what is new, run experiments, build the prototypes that prove whether an idea has legs.

## What You Will Do

- Research and experiment with new AI models, tools, frameworks, and techniques as they emerge
- Build proof-of-concept implementations and working prototypes
- Design and build AI-powered workflows, agent systems, and automation tools
- Share findings with engineering and business teams
- Build functional AI applications to validate business hypotheses quickly
...
- Background in enterprise software or B2B products`,
    screeningQuestions: [
      ...
      {
        id: "q3",
        question: "Have you completed your undergraduate education?",
        type: "YES_NO",
        required: true,
      },
      {
